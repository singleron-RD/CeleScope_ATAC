...
@add_log
def counter_barcode_rank_plot_data(count_data, log_uniform=False):
    """
    ...
    sorted_counts = np.array(count_data['total_frags'])
...
def build_plot_data_dict(plot_segment, counts):
    ...
    - counts: Reverse sorted fragments for all barcodes.
    """
